...
const Benefits = () => {
  return (
    <div className="bg-[#08080c] text-white p-4 sm:p-8 md:p-16">
      ...
      {/* Benefits Cards */}
      <div className="grid gap-8 mt-10 text-gray-600 text-[18px] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {/* Card 1 */}
        <div className="bg-white p-6 rounded-md shadow-sm h-full">
          <img
            className="h-6 w-7 sm:h-10"
            src="/Group.png"
            alt="Customize Icon"
          />
          <h2 className="text-xl text-gray-700 mt-5 font-semibold">
            Customize with ease
          </h2>
          <p className="text-[15px] mt-3">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do
      ...
      {/* Logos Grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-32 mt-10 text-center justify-cente">
        <img src="/Logo Number.svg" alt="Logo 1" />
        <img src="/Logo 2.svg" alt="Logo 2" />
        <img src="/Logo 2.svg" alt="Logo 3" />
        <img src="/Logo 2.svg" alt="Logo 4" />
