...
//   return (
//     <>
//       <div className=" w-full max-w-[1420px] bg-amber-400 max-h-[500px]">
//         <div>
//           <h1
//             className="text-white text-center font-poppins text-[42.6px] not-italic font-semibold leading-[56.8px]
//  w-[647px] h-[114px] mx-[386px]"
//           >
//             Let's build something great together
//           </h1>
//           <p
//             className="text-white text-center font-poppins text-[14.2px] not-italic font-medium leading-[24.85px] mx-[460px] mt-[17px] w-[498px] h-[50px]
// "
//           >
...
//           </p>
//           <button
//             className="flex w-[204.125px] h-[56.8px] px-[58.575px] pt-[14.2px] pb-[13.6px] justify-center items-center shrink-0
//  rounded-[36px] bg-[#FF7800] mx-[607px] mt-[35px] mb-[55px]"
//           >
//             <span
//               className="text-[#1B1C2B] font-manrope text-[15.975px] not-italic font-semibold leading-[28.4px]
// "
//             >
//               {" "}
//               Contact Us{" "}
...
const Together = () => {
  return (
    <div className="w-full bg-amber-400 max-w-[1420px] mx-auto py-12 px-4 text-center">
