      ...
      <div className="flex justify-center items-center w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 px-6 w-full max-w-8xl gap-6 mx-auto">
          {filteredCards.map((card) => (
            <div key={card.id}>
              <div className="bg-[#92c8ef] rounded text-black w-full max-w-[552px] h-auto min-h-[337px] p-[16px] flex flex-col justify-center text-center mx-[42px]">
                <img
                  src={card.img}
                  alt={card.title}
                  className=" object-cover rounded mx-4 my-4 w-full h-auto 
         sm:max-w-[300px] sm:h-[200px] 
         md:max-w-[400px] md:h-[250px] 
         lg:max-w-[483px] lg:h-[281px]"
                />
              </div>
