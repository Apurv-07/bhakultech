...
const Ourteam = () => {
  ...
  const slides = [
    {
      image: "Aboutimg/serious-man-3760373.svg",
    },
    {
      image: "Aboutimg/serious-man-3760373.svg",
    },
    {
      image: "Aboutimg/man-in-white-shirt-wearing-blue-bucket-hat-6626874.svg",
    },
    {
      image:
        "Aboutimg/transgender-model-touching-forehead-in-neon-light-7613875.svg",
      label: "",
    },
  ];
            ...
            <Slider {...settings}>
              {slides.map((slide, idx) => (
                <div key={idx} className="px-2">
                  <div className="flex flex-col items-center text-center">
                    <img src={slide.image} alt={slide.label} />
                    <p className="mb-2 text-sm font-semibold">{slide.label}</p>
                  </div>
                </div>
              ))}
            </Slider>
